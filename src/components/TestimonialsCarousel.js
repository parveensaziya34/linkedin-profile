...
const TestimonialsCarousel = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 border-2 mt-8 border-orange-500 rounded-lg shadow-lg">
      {/* Heading Section */}
      <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-left mt-12">
        In<i className="font-bold text-orange-600">sider glimpses:</i> Click to see real
        <div>conversations with our learners</div>
      </h2>
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="w-full md:w-1/4 mt-8 md:mt-0 md:ml-10">
          <div className=" flex justify-center w-60 h-100 rounded-2xl">
            <Image
              src={testimonials[activeIndex].ss}
              alt={testimonials[activeIndex].name}
              width={300}
      ...
      {/* CTA Button */}
      <button className="flex centre mt-6 px-4 mb-8 py-3 bg-orange-600 text-white font-semibold rounded-md block hover:bg-indigo-700 transition">
        Free Career Counseling from Experts
      </button>
    </div>
  );
