...
const TestimonialsCarousel = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-2 border-2 mt-12 border-orange-500 rounded-lg bg-[rgba(211,211,211,0.3)] shadow-lg">
      <h2 className="max-w-[600px] mx-auto text-base sm:text-2xl md:text-4xl font-bold text-left ml-0 mt-12">
        <span className="inline md:inline-block text-[20px] md:text-[40px]">
        In<span className="font-bold" style={{ color: 'rgb(139, 69, 19)' }}>sider glimpses:</span>
        </span>
          ...
          <Slider {...settings}>
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="w-18 h-18 sm:w-28 sm:h-28 mx-auto overflow-hidden left-6">
                <div className="w-full md:w-4/3 overflow-hidden">
                  <Image
...
const NextArrow = ({ onClick }) => (
  <div
    className="absolute right-0 md:right-0 top-1/2 transform -translate-y-1/2 cursor-pointer text-4xl text-gray-600 z-10 bg-orange-100 rounded-2xl overflow-hidden"
    onClick={onClick}
  >
    <IoIosArrowForward />
  </div>
...
const PrevArrow = ({ onClick }) => (
  <div
    className="absolute left-0 md:left-1 top-1/2 transform -translate-y-1/2 cursor-pointer text-4xl text-gray-600 z-10 bg-orange-100 rounded-2xl overflow-hidden"
    onClick={onClick}
  >
    <IoIosArrowBack />
  </div>
